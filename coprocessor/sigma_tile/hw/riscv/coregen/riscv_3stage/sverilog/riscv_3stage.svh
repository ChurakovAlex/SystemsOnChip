...
`ifndef __genstructdel_riscv_3stage_Ext_coproc_struct_
`define __genstructdel_riscv_3stage_Ext_coproc_struct_
typedef struct packed {
	logic unsigned [31:0] instr_code;
	logic unsigned [31:0] src0;
	logic unsigned [31:0] src1;
} riscv_3stage_Ext_coproc_struct;
`endif // __genstructdel_riscv_3stage_Ext_coproc_struct_

`ifndef __genstructdel_genpmodule_riscv_3stage_genmcopipe_coproc_M_if_genstruct_fifo_wdata_
`define __genstructdel_genpmodule_riscv_3stage_genmcopipe_coproc_M_if_genstruct_fifo_wdata_
typedef struct packed {
	logic unsigned [0:0] we;
	riscv_3stage_Ext_coproc_struct wdata;
} genpmodule_riscv_3stage_genmcopipe_coproc_M_if_genstruct_fifo_wdata;
`endif // __genstructdel_genpmodule_riscv_3stage_genmcopipe_coproc_M_if_genstruct_fifo_wdata_

`ifndef __genstructdel_genpmodule_riscv_3stage_genmcopipe_coproc_custom0_if_genstruct_fifo_wdata_
`define __genstructdel_genpmodule_riscv_3stage_genmcopipe_coproc_custom0_if_genstruct_fifo_wdata_
typedef struct packed {
	logic unsigned [0:0] we;
	riscv_3stage_Ext_coproc_struct wdata;
} genpmodule_riscv_3stage_genmcopipe_coproc_custom0_if_genstruct_fifo_wdata;
`endif // __genstructdel_genpmodule_riscv_3stage_genmcopipe_coproc_custom0_if_genstruct_fifo_wdata_

`endif // __riscv_3stage_h_
